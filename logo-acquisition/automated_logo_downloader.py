...
class LogoDownloader:
    ...
    def search_wikipedia_logo(self, brand_name):
        ...
        patterns = [
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{brand_name.replace(' ', '_')}_logo.svg/400px-{brand_name.replace(' ', '_')}_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{brand_name.replace(' ', '_')}_logo.png/400px-{brand_name.replace(' ', '_')}_logo.png",
            f"https://upload.wikimedia.org/wikipedia/commons/{brand_name.replace(' ', '_')}_logo.png",
            f"https://upload.wikimedia.org/wikipedia/en/thumb/4/47/{brand_name.replace(' ', '_')}_logo.png/400px-{brand_name.replace(' ', '_')}_logo.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{brand_name}_Logo.svg/400px-{brand_name}_Logo.svg.png",
        ]
    ...
    def download_known_logos(self):
        ...
        known_logos = {
            # Japanese Big 4
            'Yamaha': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Yamaha_Motor_logo.svg/400px-Yamaha_Motor_logo.svg.png',
            'Kawasaki': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Kawasaki_motorcycles_logo.png/300px-Kawasaki_motorcycles_logo.png',
            'Suzuki': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Suzuki_logo_2.svg/400px-Suzuki_logo_2.svg.png',
            
            # Italian
            'Ducati': 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Ducati_red_logo.png/300px-Ducati_red_logo.png',
            'Aprilia': 'https://upload.wikimedia.org/wikipedia/commons/4/47/Aprilia-logo.png',
            'MV Agusta': 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/MV-Agusta-Logo.svg/400px-MV-Agusta-Logo.svg.png',
            'Moto Guzzi': 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Moto_Guzzi_logo.svg/400px-Moto_Guzzi_logo.svg.png',
            ...
            # Austrian/German
            'KTM': 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/KTM-Sportmotorcycle_logo.svg/400px-KTM-Sportmotorcycle_logo.svg.png',
            'Husqvarna': 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Husqvarna_Motorcycles_logo.svg/400px-Husqvarna_Motorcycles_logo.svg.png',
            
            # British
            'Triumph': 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Triumph_Motorcycles_logo.svg/400px-Triumph_Motorcycles_logo.svg.png',
            'Norton': 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Norton_Motorcycle_Company_logo.svg/400px-Norton_Motorcycle_Company_logo.svg.png',
            'BSA': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/BSA_motorcycles_logo.svg/400px-BSA_motorcycles_logo.svg.png',
            
            # American
            'Indian': 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Indian_Motorcycle_logo.svg/400px-Indian_Motorcycle_logo.svg.png',
            'Victory': 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Victory_Motorcycles_logo.png',
            'Buell': 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Buell_logo.svg/400px-Buell_logo.svg.png',
            
            # Other major brands
            'Royal Enfield': 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Royal-Enfield-Logo.png/400px-Royal-Enfield-Logo.png',
            'Bajaj': 'https://upload.wikimedia.org/wikipedia/commons/d/dd/Bajaj_Auto_Logo.png',
            'Hero': 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Hero_MotoCorp_Logo.svg/400px-Hero_MotoCorp_Logo.svg.png',
            'TVS': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/TVS_Motor_Company_Logo.svg/400px-TVS_Motor_Company_Logo.svg.png',
            'Vespa': 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Vespa_logo.svg/400px-Vespa_logo.svg.png',
            'Piaggio': 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Piaggio_logo.svg/400px-Piaggio_logo.svg.png',
            ...
            'Polaris': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Polaris_Industries_logo.svg/400px-Polaris_Industries_logo.svg.png',
            'Ural': 'https://upload.wikimedia.org/wikipedia/commons/8/84/Ural_Motorcycles_logo.png',
            'Jawa': 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/JAWA_logo.svg/400px-JAWA_logo.svg.png',
            'Beta': 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Beta_logo.svg/400px-Beta_logo.svg.png',
            'GAS GAS': 'https://upload.wikimedia.org/wikipedia/commons/3/33/Gas_Gas_logo.png',
            'Sherco': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Sherco_logo.svg/400px-Sherco_logo.svg.png',
            ...
            'Daelim': 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Daelim_Motor_Company_logo.svg/400px-Daelim_Motor_Company_logo.svg.png',
            ...
            'Cagiva': 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Cagiva_logo.svg/400px-Cagiva_logo.svg.png',
