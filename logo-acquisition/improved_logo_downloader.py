...
class ImprovedLogoDownloader:
    ...
    def get_wikimedia_urls(self, brand_name):
        ...
        patterns = [
            ...
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{clean_name}_logo.svg/400px-{clean_name}_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{clean_name}_Motor_logo.svg/400px-{clean_name}_Motor_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{clean_name}_Motorcycles_logo.svg/400px-{clean_name}_Motorcycles_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/{clean_name}_logo_2.svg/400px-{clean_name}_logo_2.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/{clean_name}_logo.svg/400px-{clean_name}_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/{clean_name}_logo.svg/400px-{clean_name}_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/{clean_name}_logo.svg/400px-{clean_name}_logo.svg.png",
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/{clean_name}_logo.svg/400px-{clean_name}_logo.svg.png",
            ...
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{clean_name}_logo.png/300px-{clean_name}_logo.png",
            
            # English Wikipedia patterns
            f"https://upload.wikimedia.org/wikipedia/en/thumb/4/47/{clean_name}_logo.png/300px-{clean_name}_logo.png",
            f"https://upload.wikimedia.org/wikipedia/en/4/47/{clean_name}_logo.png",
            
            # Variations with underscores and hyphens
            f"https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/{clean_name.replace('_', '-')}_logo.svg/400px-{clean_name.replace('_', '-')}_logo.svg.png",
