...
if __name__ == "__main__":
    ...
    # Create search guide
    guide_file = "/Users/kevintong/Documents/Code/bikenode.com/logo-acquisition/search_guide.json"
    count = create_search_guide(csv_file, guide_file)
    print(f"\nCreated search guide for {count} active brands")
    
    # Create naming guide
    naming_file = "/Users/kevintong/Documents/Code/bikenode.com/logo-acquisition/naming_guide.txt"
