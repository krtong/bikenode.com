...
export function renderBrands(brands, type) {
    ...
    Object.keys(grouped).sort().forEach(letter => {
        ...
        separator.className = 'brand-letter-separator';
        ...
        grouped[letter].forEach(brand => {
            ...
            brandItem.innerHTML = `
                <div class="brand-icon">${icons[type] || icons['bicycle']}</div>
                <div class="brand-name" data-brand="${brand.name}">${brand.name}</div>
                ${brand.count ? `<div class="brand-count">${brand.count} models</div>` : ''}
            `;
    ...
    if (type === 'bicycle') {
        ...
        variants.forEach(variant => {
            ...
            variantItem.innerHTML = `
                <div class="variant-icon"><svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="18" r="3"></circle><circle cx="12" cy="6" r="3"></circle><path d="M12 9v6"></path></svg></div>
                <div class="variant-info">
                    <h4>${variant}</h4>
                    <p>View specifications</p>
                </div>
                <div class="variant-arrow"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></div>
            `;
        ...
        variants.forEach(variant => {
            ...
            variantItem.className = 'variant-item';
            variantItem.innerHTML = `
                <div class="variant-icon"><svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="18" r="3"></circle><circle cx="6" cy="18" r="3"></circle><path d="M6 15h12v-4l-3-3h-6l-3 3v4z"></path></svg></div>
                <div class="variant-info">
