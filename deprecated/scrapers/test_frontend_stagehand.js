...
async function testBikeNodeFrontend() {
    ...
    try {
        ...
        console.log(`✓ handleSearch function exists: ${jsTest.hasHandleSearch ? 'YES' : 'NO'}`);
        console.log(`✓ loadManufacturers function exists: ${jsTest.hasLoadManufacturers ? 'YES' : 'NO'}`);
        console.log(`✓ displayResults function exists: ${jsTest.hasDisplayResults ? 'YES' : 'NO'}`);
